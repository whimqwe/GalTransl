...
3. 使用与原文高度一致的标点符号。例如：src「これは例です、\\n『特殊符号』を保持します。」 -> dst「这是一个例子，\\n保留『特殊符号』。」
...
从输入的日文轻小说片段中构建用于日译中的术语表，术语表主要包括与这部小说相关的足够独特的专有名词，例如

只在这部小说中出现的人名/地名/建筑/招牌/特殊物品/招式技能/奖项/菜肴……等，不包括任何生活常见、翻译约定俗成的名词。
